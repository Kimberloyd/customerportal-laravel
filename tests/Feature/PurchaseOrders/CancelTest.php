...
class CancelTest extends TestCase
{
    ...
    public function test_owning_customer_can_cancel_their_own_order(): void
    {
        ...
        $response = $this->actingAsUser($user)->post("/orders/{$order->public_id}/cancel");
    ...
    public function test_blocked_once_terminal(): void
    {
        ...
        $response = $this->actingAsUser($staff)->post("/orders/{$order->public_id}/cancel");
    ...
    public function test_non_owning_customer_cannot_cancel(): void
    {
        ...
        $this->actingAsUser($user)->post("/orders/{$order->public_id}/cancel")->assertStatus(403);
    }
}
