...
export default function GuestLayout({ children }) {
    return (
        <main className="grid min-h-screen bg-white dark:bg-background lg:grid-cols-2">
            <a
                href="#main-content"
            ...
            <section className="relative hidden overflow-hidden bg-white px-12 py-10 dark:bg-background lg:flex lg:flex-col lg:items-start xl:px-20 xl:py-14">
                <Link
                    href="/"
