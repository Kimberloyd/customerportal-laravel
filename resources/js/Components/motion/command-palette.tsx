        ...
        >
          <div className="flex items-center gap-3 border-b border-gray-200 px-4">
            ...
            <input
              ...
              style={{ outline: "none", boxShadow: "none", forcedColorAdjust: "none" }}
              className={cn(
                "h-12 flex-1 border-0 bg-transparent text-sm text-foreground placeholder:text-muted-foreground outline-none ring-0 focus:border-0 focus:shadow-none focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0",
                  ...
                  {list.map((it) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {it.hint ? (
                          <kbd className="relative z-10 flex h-5 min-w-[3rem] items-center justify-center whitespace-nowrap rounded border border-border bg-background px-1.5 text-[10px] uppercase leading-none text-muted-foreground">
                            {it.hint}
                          </kbd>
                        ) : null}
                      </button>
