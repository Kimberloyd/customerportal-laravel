        ...
        () => [
            {
                ...
                header: 'PO Number',
                cell: (order) => (
                    <Link href={route('purchase-orders.show', order.public_id)} className="font-medium text-primary">
                        {order.po_number}
                    </Link>
                ),
            },
                        ...
                        <nav className="no-print mt-4 flex flex-wrap items-center gap-1 text-sm">
                            {orders.links.map((link, index) => (
                                <Link
                                    ...
                                    className={`rounded px-3 py-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--focus-ring)] ${
                                        link.active
