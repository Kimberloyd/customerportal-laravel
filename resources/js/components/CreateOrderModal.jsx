                    ...
                    return (
                        <div className="flex items-center gap-1.5">
                            <button
                                ...
                                onClick={() => updateQuantity(line.key, String(Math.max(minQuantity, quantity - 1)))}
                                aria-label={`Decrease quantity for ${line.product_name}`}
                                className="grid h-8 w-8 shrink-0 place-items-center rounded-full border border-border text-muted-foreground transition-colors hover:bg-hover disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:bg-transparent"
                            >
                                <Minus className="h-3.5 w-3.5" />
                            </button>
                            <Input
                      ...
                      cell: (line) => (
                          <button
                              ...
                              title={isEditing && line.item_id && line.delivered_quantity > 0
                                  ...
                                  : undefined}
                              className="grid h-7 w-7 place-items-center rounded-full text-muted-foreground transition-colors hover:bg-hover hover:text-foreground disabled:cursor-not-allowed disabled:opacity-35 disabled:hover:bg-transparent"
                          >
            ...
            >
                        ...
                        {canEditItems && (productsError ? (
                            <div className="flex justify-center">
                                <button
                                    ...
                                    className="flex h-9 w-80 items-center justify-center gap-2 rounded-full border border-destructive/30 bg-transparent px-4 text-sm text-destructive hover:border-destructive/50"
                                >
                                ...
                                {canEditItems && <div className="flex items-center gap-2">
                                    ...
                                    {selectedLineIds.length > 0 && (
                                        <button
                                            ...
                                            className="grid h-7 w-7 place-items-center rounded-full text-muted-foreground hover:bg-hover hover:text-foreground"
                                        >
                                            <Trash2 className="h-4 w-4" />
                                        </button>
                                    )}
                ...
                <Step>
                    <div className="space-y-5 pt-2">
                            ...
                            {isEditing && initialOrder.has_attachment && (
                                <label className="mb-3 flex items-center gap-2 text-sm text-muted-foreground">
                                    <input
                                        ...
                                        className="rounded border-border text-primary focus:ring-0 focus-visible:ring-2 focus-visible:ring-primary"
                                    />
                        ...
                        {!isEditing && <div>
                            <label htmlFor="create-order-remarks" className="mb-1 block text-sm font-medium text-foreground">
                ...
                <Step>
                    <div className="space-y-5 pt-2">
                        <div>
                            <label className="mb-1 block text-sm font-medium text-foreground">Products</label>
