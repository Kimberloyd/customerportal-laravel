      ...
      >
        ...
        <SwitchPrimitive.Root
          ...
          style={{
            ...
            // Upstream hardcodes #6B97FF/#5C89F2. Mapped to the brand indigo
            // so the "on" track is the app's one interactive accent rather
            // than a second, competing blue.
            backgroundColor: checked
              ? hovered ? "hsl(238 52% 32%)" : "var(--primary)"
              : hovered
