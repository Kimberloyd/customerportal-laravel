            ...
            ? configEntries.map(([category, values]) => {
                ...
                return (
                  <Bar
                    ...
                    fill={color}
                    className="transition-opacity duration-150 ease-out [&_.recharts-bar-rectangle]:transition-opacity [&_.recharts-bar-rectangle]:duration-150"
                    activeBar={{ fillOpacity: 1, stroke: color, strokeOpacity: 1, strokeWidth: 2 }}
                    {...barProps}
                  />
                )
              })
