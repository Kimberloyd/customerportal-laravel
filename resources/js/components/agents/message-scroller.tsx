...
// The title/description clamp to their card's actual rendered size via CSS
// (line-clamp, set on [data-slot=preview-rail-title/description] in
// message-scroller's own previewClassName) — text is handed over whole so the
// browser's ellipsis lands exactly where the box runs out of room, rather
// than at a fixed character count that leaves space unused at other widths.
function getMessagePreview(
  ...
  return {
    label: text,
    description: responseText || undefined,
  };
}
